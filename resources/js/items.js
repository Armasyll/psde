...
Game.createItemEntity("axe02", "Curved Axe", "", "axe02Icon", "axe02", undefined, ItemEnum.WEAPON);
Game.createItemEntity("battleAxe01", "Double-headed Axe", "", "battleAxe01Icon", "battleAxe01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("cross01", "Cross", "A metal-capped cross.", "cross01Icon", "cross01", "cross01", ItemEnum.WEAPON);
Game.createItemEntity("cudgel01", "Cudgel", "A chunk of metal attached to a stick.", "cudgel01Icon", "cudgel01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("forgeHammer01", "Blacksmith's Hammer", "", "forgeHammer01Icon", "forgeHammer01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("gladius01", "Gladius", "", "gladius01Icon", "gladius01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("glaive01", "Glaive", "", "glaive01Icon", "glaive01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("harpe", "Harpe", "A Sword with a curved falange. Not a harp, the instrument.", "harpeIcon", "harpe", undefined, ItemEnum.WEAPON);
Game.createItemEntity("katana01", "Katana", "", "katana01Icon", "katana01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("knife01", "Knife", "A dull knife.", "knife01Icon", "knife01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("morningstar", "Morningstar", "A spiked mace.", "morningstarIcon", "morningstar", undefined, ItemEnum.WEAPON);
Game.createItemEntity("shortSword01", "Short Sword", "A simple short Sword.", "shortSword01Icon", "shortSword01", undefined, ItemEnum.WEAPON);
Game.createItemEntity("spear01", "Spear", "", "spear01Icon", "spear01", undefined, ItemEnum.WEAPON);
...
Game.createItemEntity("sword01", "Sword", "A simple Sword.", "sword01Icon", "sword01", undefined, ItemEnum.WEAPON);
...
Game.createItemEntity("warhammer01", "Warhammer", "A dangerous looking, spiked hammer.", "warhammer01Icon", "warhammer01", undefined, ItemEnum.WEAPON);
...
Game.createItemEntity("pickaxe01", "Pickaxe", "A pickaxe.", "pickaxe01Icon", "pickaxe01", undefined, ItemEnum.WEAPON);
