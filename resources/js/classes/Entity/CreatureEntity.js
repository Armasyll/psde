class CreatureEntity extends Entity {
    ...
    assign(entity, verify = true) {
        ...
        if (entity.hasOwnProperty("strength")) this.strength = entity.strength;
        if (entity.hasOwnProperty("dexterity")) this.dexterity = entity.dexterity;
        if (entity.hasOwnProperty("constitution")) this.constitution = entity.constitution;
        if (entity.hasOwnProperty("intelligence")) this.intelligence = entity.intelligence;
        if (entity.hasOwnProperty("wisdom")) this.wisdom = entity.wisdom;
        if (entity.hasOwnProperty("charisma")) this.charisma = entity.charisma;
        ...
        if (entity.hasOwnProperty("conscious")) this.conscious = entity.conscious;
        if (entity.hasOwnProperty("paralyzed")) this.paralyzed = entity.paralyzed;
