class CharacterStatsGUI {
    ...
    static resize() {
        ...
        CharacterStatsGUI.titleBar.heightInPixels = GameGUI.titleBarHeightInPixels;
        CharacterStatsGUI.title.widthInPixels = CharacterStatsGUI.titleBar.widthInPixels - GameGUI.getFontSizeInPixels(2);
        CharacterStatsGUI.closeButton.width = GameGUI.getFontSize(2);
        CharacterStatsGUI.closeButton.height = GameGUI.getFontSize(2);
        CharacterStatsGUI.bodyContainer.widthInPixels = CharacterStatsGUI.controller.widthInPixels;
        CharacterStatsGUI.bodyContainer.heightInPixels = CharacterStatsGUI.controller.heightInPixels - CharacterStatsGUI.titleBar.heightInPixels;

        CharacterStatsGUI.header.heightInPixels = Math.floor(Math.max(GameGUI.fontSizeInPixelsWithSpacing * 4, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.header.width = CharacterStatsGUI.bodyContainer.width;
        CharacterStatsGUI.nameContainer.height = CharacterStatsGUI.header.height;
        CharacterStatsGUI.nameContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.header.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.nameField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.nameContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.nameField.widthInPixels = CharacterStatsGUI.nameContainer.widthInPixels - GameGUI.fontSizeSpacing;
        ...
        CharacterStatsGUI.infoContainer.widthInPixels = Math.floor(Math.max((CharacterStatsGUI.header.widthInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.infoTop.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.infoContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.classContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoTop.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.classField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.classContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.backgroundContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoTop.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.backgroundField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.backgroundContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.accountContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoTop.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.accountField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.accountContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.infoBottom.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.infoContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.raceContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoBottom.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.raceField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.raceContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.alignmentContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoBottom.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.alignmentField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.alignmentContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.xpContainer.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.infoBottom.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.xpField.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.xpContainer.heightInPixels / 3) * 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.body.heightInPixels = Math.floor(CharacterStatsGUI.bodyContainer.heightInPixels - CharacterStatsGUI.header.heightInPixels);
        CharacterStatsGUI.body.width = CharacterStatsGUI.bodyContainer.width;
        CharacterStatsGUI.colA.height = CharacterStatsGUI.body.height;
        CharacterStatsGUI.colA.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.body.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.colARowA.heightInPixels = Math.floor((CharacterStatsGUI.colA.heightInPixels / 7) * 4.75);
        ...
        CharacterStatsGUI.colARowAColA.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowA.widthInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.strengthContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.strengthButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.strengthContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.strengthIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.strengthButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.strengthDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.strengthButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.strengthData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.strengthContainer.widthInPixels - CharacterStatsGUI.strengthButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.strengthLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.strengthContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.dexterityContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.dexterityButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.dexterityContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.dexterityIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.dexterityButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.dexterityDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.dexterityButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.dexterityData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.dexterityContainer.widthInPixels - CharacterStatsGUI.dexterityButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.dexterityLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.dexterityContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.constitutionContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.constitutionButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.constitutionContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.constitutionIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.constitutionButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.constitutionDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.constitutionButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.constitutionData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.constitutionContainer.widthInPixels - CharacterStatsGUI.constitutionButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.constitutionLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.constitutionContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.intelligenceContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.intelligenceButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.intelligenceContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.intelligenceIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.intelligenceButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.intelligenceDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.intelligenceButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.intelligenceData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.intelligenceContainer.widthInPixels - CharacterStatsGUI.intelligenceButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.intelligenceLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.intelligenceContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.wisdomContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.wisdomButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.wisdomContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.wisdomIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.wisdomButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.wisdomDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.wisdomButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.wisdomData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.wisdomContainer.widthInPixels - CharacterStatsGUI.wisdomButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.wisdomLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.wisdomContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.charismaContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColA.heightInPixels / 6, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.charismaButtons.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.charismaContainer.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.charismaIncButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.charismaButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.charismaDecButton.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.charismaButtons.heightInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.charismaData.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.charismaContainer.widthInPixels - CharacterStatsGUI.charismaButtons.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.charismaLabel.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.charismaContainer.heightInPixels / 4, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.colARowAColB.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowA.widthInPixels / 2, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.inspirationContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColB.heightInPixels / 12, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.inspirationLabel.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.inspirationContainer.widthInPixels - CharacterStatsGUI.inspirationField.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.inspirationLabel.fontSize = GameGUI.fontSizeSmall;
        CharacterStatsGUI.proficiencyBonusContainer.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowAColB.heightInPixels / 12, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.proficiencyBonusLabel.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.proficiencyBonusContainer.widthInPixels - CharacterStatsGUI.proficiencyBonusField.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.proficiencyBonusLabel.fontSize = GameGUI.fontSizeSmall;
        CharacterStatsGUI.savingThrowContainer.heightInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 8);
        ...
        CharacterStatsGUI.savingThrowStrengthField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.savingThrowDexterityField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.savingThrowConstitutionField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.savingThrowIntelligenceField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.savingThrowWisdomField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.savingThrowCharismaField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillContainer.heightInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 18);
        ...
        CharacterStatsGUI.skillAcrobaticsField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillAnimalHandlingField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillArcanaField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillAthleticsField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillDeceptionField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillHistoryField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillInsightField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillIntimidationField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillInvestigationField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillMedicineField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillNatureField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillPerceptionField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillPerformanceField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillPersuasionField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillReligionField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillSleightOfHandField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.skillStealthField.widthInPixels = Math.floor(GameGUI.fontSizeSmallInPixels * 3);
        ...
        CharacterStatsGUI.colARowB.heightInPixels = Math.floor(Math.max((CharacterStatsGUI.colA.heightInPixels / 7) * 0.5, GameGUI.fontSizeInPixelsWithSpacing));
        ...
        CharacterStatsGUI.passiveWisdomLabel.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.colARowB.widthInPixels - CharacterStatsGUI.passiveWisdomField.widthInPixels, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.passiveWisdomLabel.fontSize = GameGUI.fontSizeSmall;
        CharacterStatsGUI.proficienciesAndLanguagesContainer.heightInPixels = Math.floor((CharacterStatsGUI.colA.heightInPixels / 7) * 2.5);
        CharacterStatsGUI.proficienciesAndLanguagesContainer.width = CharacterStatsGUI.colA.width;
        CharacterStatsGUI.proficienciesAndLanguagesField.heightInPixels = Math.floor(CharacterStatsGUI.proficienciesAndLanguagesContainer.heightInPixels - GameGUI.fontSizeSmallInPixels);
        ...
        CharacterStatsGUI.colB.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.body.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        CharacterStatsGUI.colC.height = CharacterStatsGUI.body.height;
        CharacterStatsGUI.colC.widthInPixels = Math.floor(Math.max(CharacterStatsGUI.body.widthInPixels / 3, GameGUI.fontSizeInPixelsWithSpacing));
        return 0;
    }
    static generateController() {
        [CharacterStatsGUI.controller, CharacterStatsGUI.titleBar, CharacterStatsGUI.title, CharacterStatsGUI.closeButton, CharacterStatsGUI.bodyContainer] = GameGUI.createWindow("characterStats", "Stats", CharacterStatsGUI.defaultWidthInPixels, CharacterStatsGUI.defaultHeightInPixels, 2);
        CharacterStatsGUI.controller.isVertical = true;
        let header = GameGUI.createStackPanel("header");
            header.heightInPixels = Math.floor(GameGUI.fontSizeInPixelsWithSpacing * 4);
            header.width = CharacterStatsGUI.bodyContainer.width;
        ...
        CharacterStatsGUI.bodyContainer.addControl(header);
        let body = GameGUI.createStackPanel("body");
            body.heightInPixels = Math.floor(Math.max(CharacterStatsGUI.bodyContainer.heightInPixels - (GameGUI.fontSizeInPixelsWithSpacing * 3), GameGUI.fontSizeInPixelsWithSpacing));
            body.width = CharacterStatsGUI.bodyContainer.width;
        ...
        CharacterStatsGUI.bodyContainer.addControl(body);
        ...
        CharacterStatsGUI.closeButton.onPointerUpObservable.add(function() {
            CharacterStatsGUI.hide();
        });
    ...
    static setResponse(creatureController, response, callbackID) {
        CharacterStatsGUI.nameField.text = response.name;
        CharacterStatsGUI.classField.text = response.primaryCharacterClass.name;
        //CharacterStatsGUI.backgroundField.text = creatureEntity.get();
        //CharacterStatsGUI.accountNameField.text = creatureEntity.get();
        CharacterStatsGUI.raceField.text = CreatureSubTypeEnum.properties[response.creatureSubType].name;
        ...
        CharacterStatsGUI.inspirationField.text = String(number);
        // saving throws
        ...
        CharacterStatsGUI.skillAcrobaticsCheckbox.isChecked = response.proficiencies.hasOwnProperty("ACROBATICS");
        number = response.skillScores["ANIMAL_HANDLING"];
        CharacterStatsGUI.skillAnimalHandlingField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillAnimalHandlingCheckbox.isChecked = response.proficiencies.hasOwnProperty("ANIMAL_HANDLING");
        number = response.skillScores["ARCANA"];
        CharacterStatsGUI.skillArcanaField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillArcanaCheckbox.isChecked = response.proficiencies.hasOwnProperty("ARCANA");
        number = response.skillScores["ATHLETICS"];
        CharacterStatsGUI.skillAthleticsField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillAthleticsCheckbox.isChecked = response.proficiencies.hasOwnProperty("ATHLETICS");
        number = response.skillScores["DECEPTION"];
        CharacterStatsGUI.skillDeceptionField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillDeceptionCheckbox.isChecked = response.proficiencies.hasOwnProperty("DECEPTION");
        number = response.skillScores["HISTORY"];
        CharacterStatsGUI.skillHistoryField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillHistoryCheckbox.isChecked = response.proficiencies.hasOwnProperty("HISTORY");
        number = response.skillScores["INSIGHT"];
        CharacterStatsGUI.skillInsightField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillInsightCheckbox.isChecked = response.proficiencies.hasOwnProperty("INSIGHT");
        number = response.skillScores["INTIMIDATION"];
        CharacterStatsGUI.skillIntimidationField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillIntimidationCheckbox.isChecked = response.proficiencies.hasOwnProperty("INTIMIDATION");
        number = response.skillScores["INVESTIGATION"];
        CharacterStatsGUI.skillInvestigationField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillInvestigationCheckbox.isChecked = response.proficiencies.hasOwnProperty("INVESTIGATION");
        number = response.skillScores["MEDICINE"];
        CharacterStatsGUI.skillMedicineField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillMedicineCheckbox.isChecked = response.proficiencies.hasOwnProperty("MEDICINE");
        number = response.skillScores["NATURE"];
        CharacterStatsGUI.skillNatureField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillNatureCheckbox.isChecked = response.proficiencies.hasOwnProperty("NATURE");
        number = response.skillScores["PERCEPTION"];
        CharacterStatsGUI.skillPerceptionField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillPerceptionCheckbox.isChecked = response.proficiencies.hasOwnProperty("PERCEPTION");
        number = response.skillScores["PERFORMANCE"];
        CharacterStatsGUI.skillPerformanceField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillPerformanceCheckbox.isChecked = response.proficiencies.hasOwnProperty("PERFORMANCE");
        number = response.skillScores["PERSUASION"];
        CharacterStatsGUI.skillPersuasionField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillPersuasionCheckbox.isChecked = response.proficiencies.hasOwnProperty("PERSUASION");
        number = response.skillScores["RELIGION"];
        CharacterStatsGUI.skillReligionField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillReligionCheckbox.isChecked = response.proficiencies.hasOwnProperty("RELIGION");
        number = response.skillScores["SLEIGHT_OF_HAND"];
        CharacterStatsGUI.skillSleightOfHandField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillSleightOfHandCheckbox.isChecked = response.proficiencies.hasOwnProperty("SLEIGHT_OF_HAND");
        number = response.skillScores["STEALTH"];
        CharacterStatsGUI.skillStealthField.text = String((number > 0 ? "+" : "") + number);
        CharacterStatsGUI.skillStealthCheckbox.isChecked = response.proficiencies.hasOwnProperty("STEALTH");

        // proficienciesAndLanguages will include Languages, Armour, Weapons, and Tools & Kits
    }
    static update() {
        CharacterStatsGUI.set(Game.playerController);
        return 0;
    }
}