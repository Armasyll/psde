class CharacterStatsGUI {
    ...
    static resize() {
        ...
        CharacterStatsGUI.body.height = String(CharacterStatsGUI.bodyContainer.heightInPixels - CharacterStatsGUI.header.heightInPixels).concat("px");
    ...
    static generateController() {
        ...
        let body = GameGUI.createStackPanel("body");
            body.height = String(Math.max(CharacterStatsGUI.bodyContainer.heightInPixels - (GameGUI.fontSizeInPixelsWithSpacing * 3), GameGUI.fontSizeInPixelsWithSpacing)).concat("px");
