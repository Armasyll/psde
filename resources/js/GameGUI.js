class GameGUI {
    ...
    static hideMainMenuChildren() {
        for (var _i = GameGUI.mainMenu.rootContainer.children.length - 1; _i > -1; _i--) {
            GameGUI.mainMenu.rootContainer.children[_i].isVisible = false;
        }
    }
